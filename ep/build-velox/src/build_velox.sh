...
function compile {
  ...
  if [ $ENABLE_GPU == "ON" ]; then
    ...
    COMPILE_OPTION="$COMPILE_OPTION -DVELOX_ENABLE_GPU=ON -DVELOX_ENABLE_CUDF=ON -DCMAKE_CUDA_ARCHITECTURES=\"70-real;75-real;80-real;86-real;90-real;100-real;120-real\" -DCMAKE_CUDA_COMPILER=/usr/local/cuda-12.8/bin/nvcc"
  fi
